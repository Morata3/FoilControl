...
./pid/objs/armv6vfphLinux3.xgcc4.7.2/imu/imu_subscriber &
./pid/objs/armv6vfphLinux3.xgcc4.7.2/height/heightSensor_subscriber &
./debugger/objs/armv6vfphLinux3.xgcc4.7.2/debug_subscriber &
