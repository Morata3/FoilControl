...
{
    debugger *sample = NULL;

    RTIOsapiHeap_allocateStructure(&(sample),debugger);
    if (sample == NULL) {
        return NULL;
    }

    if (!debugger_initialize_w_params(sample,alloc_params)) {
...
debuggerPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!debugger_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        RTIOsapiHeap_freeStructure(sample);
        sample=NULL;
    }
...
{
    return debuggerPluginSupport_create_data_ex(RTI_TRUE);
}
...
debuggerPluginSupport_destroy_data_w_params(
    ...
    debugger_finalize_w_params(sample,dealloc_params);
...
debuggerPluginSupport_destroy_data_ex(
    ...
    debugger_finalize_ex(sample,deallocate_pointers);
...
debuggerPluginSupport_destroy_data(
    ...
    debuggerPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
debuggerPluginSupport_copy_data(
    ...
    const debugger *src)
{
    return debugger_copy(dst,(const debugger*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printFloat(
        &sample->longitud, "longitud", indent_level + 1);    

    RTICdrType_printFloat(
        &sample->latitud, "latitud", indent_level + 1);    
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        debuggerPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = debuggerPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            debuggerPlugin_get_serialized_sample_max_size, epd,
...
debuggerPlugin_return_sample(
    ...
    void *handle)
{
    debugger_finalize_optional_members(sample, RTI_TRUE);
    ...
    const debugger *src)
{
    ...
    return debuggerPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    debugger_get_typecode();
    pd.programs = debuggerPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
debuggerPlugin_serialize_to_cdr_buffer(
    ...
    const debugger *sample)
{
    return debuggerPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!debuggerPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool debuggerPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    debugger **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *debuggerPlugin_new(void) 
{ 
    ...
    debuggerPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    debuggerPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    debugger_finalize_optional_members;
    ...
    debuggerPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    debuggerPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    debuggerPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)debugger_get_typecode();
    #endif
    ...
    debuggerPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    debuggerPlugin_return_buffer;
    ...
    plugin->endpointTypeName = debuggerTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
debuggerPlugin_delete(struct PRESTypePlugin *plugin)
{
