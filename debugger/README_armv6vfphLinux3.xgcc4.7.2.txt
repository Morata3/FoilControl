...
data type debug from debug.idl.
This example builds two applications, named debug_publisher and
debug_subscriber.
...
> make -f makefile_debug_armv6vfphLinux3.xgcc4.7.2
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_debug_armv6vfphLinux3.xgcc4.7.2 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the debug_publisher.c
file where it says:
...
> objs/armv6vfphLinux3.xgcc4.7.2/debug_publisher <domain_id> <sample_count>
> objs/armv6vfphLinux3.xgcc4.7.2/debug_subscriber <domain_id> <sample_count>
