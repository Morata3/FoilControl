    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),gps);
    if (sample == NULL) {
        return NULL;
    }

    if (!gps_initialize_w_params(sample,alloc_params)) {
...
gpsPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!gps_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        RTIOsapiHeap_freeStructure(sample);
        sample=NULL;
    }
...
{
    return gpsPluginSupport_create_data_ex(RTI_TRUE);
}
...
gpsPluginSupport_destroy_data_w_params(
    ...
    gps_finalize_w_params(sample,dealloc_params);
...
gpsPluginSupport_destroy_data_ex(
    ...
    gps_finalize_ex(sample,deallocate_pointers);
...
gpsPluginSupport_destroy_data(
    ...
    gpsPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
gpsPluginSupport_copy_data(
    ...
    const gps *src)
{
    return gps_copy(dst,(const gps*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    if (sample->datos==NULL) {
        RTICdrType_printString(
            NULL,"datos", indent_level + 1);
    } else {
        RTICdrType_printString(
            sample->datos,"datos", indent_level + 1);    
    }
    ...
    void *containerPluginContext)
{
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = gpsPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            gpsPlugin_get_serialized_sample_max_size, epd,
...
gpsPlugin_return_sample(
    ...
    void *handle)
{
    gps_finalize_optional_members(sample, RTI_TRUE);
    ...
    const gps *src)
{
    ...
    return gpsPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    gps_get_typecode();
    pd.programs = gpsPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
gpsPlugin_serialize_to_cdr_buffer(
    ...
    const gps *sample)
{
    return gpsPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!gpsPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool gpsPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    gps **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *gpsPlugin_new(void) 
{ 
    ...
    gpsPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    gpsPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    gps_finalize_optional_members;
    ...
    gpsPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    gpsPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    gpsPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)gps_get_typecode();
    #endif
    ...
    gpsPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    gpsPlugin_return_buffer;
    ...
    plugin->endpointTypeName = gpsTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
gpsPlugin_delete(struct PRESTypePlugin *plugin)
{
