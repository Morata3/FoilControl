...
A publication of data of type imu
...
Example publication of type imu automatically generated by 
...
java imuSubscriber <domain_id> <sample_count>

(3) Start the publication on the same domain used for RTI Connext with the command
java imuPublisher <domain_id> <sample_count>
...
java -Djava.ext.dirs=$NDDSHOME/lib/java imuPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java imuSubscriber <domain_id>        
*/
...
public class imuPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ++count) {
                System.out.println("Writing imu, count " + count);
