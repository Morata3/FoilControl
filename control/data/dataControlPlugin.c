    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),control);
    if (sample == NULL) {
        return NULL;
    }

    if (!control_initialize_w_params(sample,alloc_params)) {
...
controlPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!control_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        RTIOsapiHeap_freeStructure(sample);
        sample=NULL;
    }
...
{
    return controlPluginSupport_create_data_ex(RTI_TRUE);
}
...
controlPluginSupport_destroy_data_w_params(
    ...
    control_finalize_w_params(sample,dealloc_params);
...
controlPluginSupport_destroy_data_ex(
    ...
    control_finalize_ex(sample,deallocate_pointers);
...
controlPluginSupport_destroy_data(
    ...
    controlPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
controlPluginSupport_copy_data(
    ...
    const control *src)
{
    return control_copy(dst,(const control*) src);
}
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        controlPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = controlPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            controlPlugin_get_serialized_sample_max_size, epd,
...
controlPlugin_return_sample(
    ...
    void *handle)
{
    control_finalize_optional_members(sample, RTI_TRUE);
    ...
    const control *src)
{
    ...
    return controlPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    control_get_typecode();
    pd.programs = controlPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
controlPlugin_serialize_to_cdr_buffer(
    ...
    const control *sample)
{
    return controlPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!controlPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool controlPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    control **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *controlPlugin_new(void) 
{ 
    ...
    controlPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    controlPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    control_finalize_optional_members;
    ...
    controlPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    controlPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    controlPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)control_get_typecode();
    #endif
    ...
    controlPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    controlPlugin_return_buffer;
    ...
    plugin->endpointTypeName = controlTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
controlPlugin_delete(struct PRESTypePlugin *plugin)
{
