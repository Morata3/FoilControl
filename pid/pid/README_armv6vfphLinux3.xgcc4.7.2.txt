...
data type pid from pid.idl.
This example builds two applications, named pid_publisher and
pid_subscriber.
...
> make -f makefile_pid_armv6vfphLinux3.xgcc4.7.2
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_pid_armv6vfphLinux3.xgcc4.7.2 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the pid_publisher.c
file where it says:
...
> objs/armv6vfphLinux3.xgcc4.7.2/pid_publisher <domain_id> <sample_count>
> objs/armv6vfphLinux3.xgcc4.7.2/pid_subscriber <domain_id> <sample_count>
