...
data type heightSensor from heightSensor.idl.
This example builds two applications, named heightSensor_publisher and
heightSensor_subscriber.

To Build this example:
======================
 
From your command shell, type:
> make -f makefile_heightSensor_armv6vfphLinux3.xgcc4.7.2
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_heightSensor_armv6vfphLinux3.xgcc4.7.2 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the heightSensor_publisher.c
file where it says:
...
> objs/armv6vfphLinux3.xgcc4.7.2/heightSensor_publisher <domain_id> <sample_count>
> objs/armv6vfphLinux3.xgcc4.7.2/heightSensor_subscriber <domain_id> <sample_count>
