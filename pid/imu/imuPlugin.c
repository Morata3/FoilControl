    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),imu);
    if (sample == NULL) {
        return NULL;
    }

    if (!imu_initialize_w_params(sample,alloc_params)) {
...
imuPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!imu_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        RTIOsapiHeap_freeStructure(sample);
        sample=NULL;
    }
...
{
    return imuPluginSupport_create_data_ex(RTI_TRUE);
}
...
imuPluginSupport_destroy_data_w_params(
    ...
    imu_finalize_w_params(sample,dealloc_params);
...
imuPluginSupport_destroy_data_ex(
    ...
    imu_finalize_ex(sample,deallocate_pointers);
...
imuPluginSupport_destroy_data(
    ...
    imuPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
imuPluginSupport_copy_data(
    ...
    const imu *src)
{
    return imu_copy(dst,(const imu*) src);
}
    ...
    void *containerPluginContext)
{
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = imuPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            imuPlugin_get_serialized_sample_max_size, epd,
...
imuPlugin_return_sample(
    ...
    void *handle)
{
    imu_finalize_optional_members(sample, RTI_TRUE);
    ...
    const imu *src)
{
    ...
    return imuPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    imu_get_typecode();
    pd.programs = imuPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
imuPlugin_serialize_to_cdr_buffer(
    ...
    const imu *sample)
{
    return imuPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!imuPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool imuPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    imu **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *imuPlugin_new(void) 
{ 
    ...
    imuPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    imu_finalize_optional_members;
    ...
    imuPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    imuPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    imuPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)imu_get_typecode();
    #endif
    ...
    imuPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    imuPlugin_return_buffer;
    ...
    plugin->endpointTypeName = imuTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
imuPlugin_delete(struct PRESTypePlugin *plugin)
{
