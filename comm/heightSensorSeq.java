...
/**
* A sequence of heightSensor instances.
*/
public final class heightSensorSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public heightSensorSeq() {
        super(heightSensor.class);
    }

    public heightSensorSeq (int initialMaximum) {
        super(heightSensor.class, initialMaximum);
    }

    public heightSensorSeq (Collection<?> elements) {
        super(heightSensor.class, elements);
    }

    public  heightSensor get(int index) { 
        return (heightSensor) super.get(index); 
    }
