...
public class heightSensorTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "heightSensor";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final heightSensorTypeSupport _singleton
    = new heightSensorTypeSupport();
    ...
    */
    public static heightSensorTypeSupport get_instance() {
        return _singleton;
    }

    public static heightSensorTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return heightSensorTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return heightSensor.create();
    }
    ...
    * <code>this</code> is not a <code>heightSensor</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        heightSensor typedDst = (heightSensor) destination;
        heightSensor typedSrc = (heightSensor) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        heightSensor typedSrc = (heightSensor) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            heightSensor typedDst = (heightSensor) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            heightSensor typedDst = (heightSensor) sample;
            deserialize_sample(
    ...
    int mask) {
        return new heightSensorDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new heightSensorDataReader(native_reader, listener, mask, this);   
    ...
    protected heightSensorTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, heightSensorTypeCode.VALUE, heightSensor.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected heightSensorTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, heightSensorTypeCode.VALUE, heightSensor.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
