...
/**
* A sequence of imu instances.
*/
public final class imuSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public imuSeq (int initialMaximum) {
        super(imu.class, initialMaximum);
    }

    public imuSeq (Collection<?> elements) {
        super(imu.class, elements);
    }

    public  imu get(int index) { 
        return (imu) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' imu objects (beyond the original size of this object)
