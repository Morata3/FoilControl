...
public class imuTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "imu";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final imuTypeSupport _singleton
    = new imuTypeSupport();
    ...
    */
    public static imuTypeSupport get_instance() {
        return _singleton;
    }

    public static imuTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return imuTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>imu</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        imu typedDst = (imu) destination;
        imu typedSrc = (imu) source;
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.name );

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.datos );
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.datos,128);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.datos = src.readString(128);
    ...
    int mask) {
        return new imuDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new imuDataReader(native_reader, listener, mask, this);   
    ...
    protected imuTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, imuTypeCode.VALUE, imu.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected imuTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, imuTypeCode.VALUE, imu.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
