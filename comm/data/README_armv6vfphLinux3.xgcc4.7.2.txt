...
data type comm from dataComm.idl.
This example builds two applications, named commPublisher
and commSubscriber.
...
command shell, type:
> make -f makefile_dataComm_armv6vfphLinux3.xgcc4.7.2

To Modify the Data:
===================
To modify the data being sent, in the default package (or module you specified),
open/double-click and edit the commPublisher.java file
where it says:
...
Run with Eclipse:
-----------------
Select Run > Run and choose either the commPublisher or commSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_dataComm_armv6vfphLinux3.xgcc4.7.2 commPublisher
> make -f makefile_dataComm_armv6vfphLinux3.xgcc4.7.2 commSubscriber
