...
public class commTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "comm";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final commTypeSupport _singleton
    = new commTypeSupport();
    ...
    */
    public static commTypeSupport get_instance() {
        return _singleton;
    }

    public static commTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return commTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>comm</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        comm typedDst = (comm) destination;
        comm typedSrc = (comm) source;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.longitud);
            dst.writeFloat(typedSrc.latitud);
            dst.writeFloat(typedSrc.pitch);
            dst.writeFloat(typedSrc.roll);
            dst.writeFloat(typedSrc.height);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.longitud = src.readFloat();
                typedDst.latitud = src.readFloat();
                typedDst.pitch = src.readFloat();
                typedDst.roll = src.readFloat();
                typedDst.height = src.readFloat();
    ...
    int mask) {
        return new commDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new commDataReader(native_reader, listener, mask, this);   
    ...
    protected commTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, commTypeCode.VALUE, comm.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected commTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, commTypeCode.VALUE, comm.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
