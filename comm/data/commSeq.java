...
/**
* A sequence of comm instances.
*/
public final class commSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public commSeq (int initialMaximum) {
        super(comm.class, initialMaximum);
    }

    public commSeq (Collection<?> elements) {
        super(comm.class, elements);
    }

    public  comm get(int index) { 
        return (comm) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' comm objects (beyond the original size of this object)
