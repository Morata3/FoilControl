...
A publication of data of type comm
...
Example publication of type comm automatically generated by 
...
java commSubscriber <domain_id> <sample_count>

(3) Start the publication on the same domain used for RTI Connext with the command
java commPublisher <domain_id> <sample_count>
...
java -Djava.ext.dirs=$NDDSHOME/class commPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/class commSubscriber <domain_id>  
*/
...
public class commSubscriber {
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            ++count) {
                System.out.println("comm subscriber sleeping for "
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((comm)_dataSeq.get(i)).toString("Received",0));
