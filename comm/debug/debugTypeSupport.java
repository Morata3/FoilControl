...
public class debugTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "debug";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final debugTypeSupport _singleton
    = new debugTypeSupport();
    ...
    */
    public static debugTypeSupport get_instance() {
        return _singleton;
    }

    public static debugTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return debugTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>debug</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        debug typedDst = (debug) destination;
        debug typedSrc = (debug) source;
    ...
    int mask) {
        return new debugDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new debugDataReader(native_reader, listener, mask, this);   
    ...
    protected debugTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, debugTypeCode.VALUE, debug.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected debugTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, debugTypeCode.VALUE, debug.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
