...
/**
* A sequence of debug instances.
*/
public final class debugSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public debugSeq (int initialMaximum) {
        super(debug.class, initialMaximum);
    }

    public debugSeq (Collection<?> elements) {
        super(debug.class, elements);
    }

    public  debug get(int index) { 
        return (debug) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' debug objects (beyond the original size of this object)
