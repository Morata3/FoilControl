...
This example builds two applications, named debugPublisher
and debugSubscriber.
...
open/double-click and edit the debugPublisher.java file
where it says:
...
Run with Eclipse:
-----------------
Select Run > Run and choose either the debugPublisher or debugSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_debug_armv6vfphLinux3.xgcc4.7.2 debugPublisher
> make -f makefile_debug_armv6vfphLinux3.xgcc4.7.2 debugSubscriber
