...
This example builds two applications, named gpsPublisher
and gpsSubscriber.
...
open/double-click and edit the gpsPublisher.java file
where it says:
...
Run with Eclipse:
-----------------
Select Run > Run and choose either the gpsPublisher or gpsSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_gps_armv6vfphLinux3.xgcc4.7.2 gpsPublisher
> make -f makefile_gps_armv6vfphLinux3.xgcc4.7.2 gpsSubscriber
