...
/**
* A sequence of gps instances.
*/
public final class gpsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public gpsSeq (int initialMaximum) {
        super(gps.class, initialMaximum);
    }

    public gpsSeq (Collection<?> elements) {
        super(gps.class, elements);
    }

    public  gps get(int index) { 
        return (gps) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' gps objects (beyond the original size of this object)
