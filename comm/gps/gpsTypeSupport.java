...
public class gpsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "gps";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final gpsTypeSupport _singleton
    = new gpsTypeSupport();
    ...
    */
    public static gpsTypeSupport get_instance() {
        return _singleton;
    }

    public static gpsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return gpsTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>gps</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        gps typedDst = (gps) destination;
        gps typedSrc = (gps) source;
    ...
    int mask) {
        return new gpsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new gpsDataReader(native_reader, listener, mask, this);   
    ...
    protected gpsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, gpsTypeCode.VALUE, gps.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected gpsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, gpsTypeCode.VALUE, gps.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
