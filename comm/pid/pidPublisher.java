...
A publication of data of type pid
...
Example publication of type pid automatically generated by 
...
java pidSubscriber <domain_id> <sample_count>

(3) Start the publication on the same domain used for RTI Connext with the command
java pidPublisher <domain_id> <sample_count>
...
java -Djava.ext.dirs=$NDDSHOME/lib/java pidPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java pidSubscriber <domain_id>        
*/
