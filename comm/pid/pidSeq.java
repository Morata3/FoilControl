...
/**
* A sequence of pid instances.
*/
public final class pidSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public pidSeq (int initialMaximum) {
        super(pid.class, initialMaximum);
    }

    public pidSeq (Collection<?> elements) {
        super(pid.class, elements);
    }

    public  pid get(int index) { 
        return (pid) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' pid objects (beyond the original size of this object)
