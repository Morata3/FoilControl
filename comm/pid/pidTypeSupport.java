...
public class pidTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "pid";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final pidTypeSupport _singleton
    = new pidTypeSupport();
    ...
    */
    public static pidTypeSupport get_instance() {
        return _singleton;
    }

    public static pidTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return pidTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>pid</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        pid typedDst = (pid) destination;
        pid typedSrc = (pid) source;
    ...
    int mask) {
        return new pidDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new pidDataReader(native_reader, listener, mask, this);   
    ...
    protected pidTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, pidTypeCode.VALUE, pid.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected pidTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, pidTypeCode.VALUE, pid.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
