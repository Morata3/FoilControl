...
This example builds two applications, named pidPublisher
and pidSubscriber.
...
open/double-click and edit the pidPublisher.java file
where it says:
...
Run with Eclipse:
-----------------
Select Run > Run and choose either the pidPublisher or pidSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_pid_armv6vfphLinux3.xgcc4.7.2 pidPublisher
> make -f makefile_pid_armv6vfphLinux3.xgcc4.7.2 pidSubscriber
